"""
Chat endpoints — Kimi proxy.

POST /v1/chat/completions   OpenAI SDK-compatible
POST /generate/text         { "prompt": "...", "model": "k2" }
"""
from fastapi import APIRouter, HTTPException, Request
from pydantic import BaseModel

from kimi_proxy.client import ask
from kimi_proxy.tracker import track
...
async def chat_completions(request: Request):
    ...
    return {
        "id": f"chatcmpl_kimi_{t.request_id}",
